        ...
        <div class="mainbar">
            <table style="width: 100%">
                <?php if (!empty($previous['id'])) { ?>
                    <td class="portf" style="width: 10%"
                        onclick="location.href='/portfolio/<?php echo $previous['id']; ?>'">&laquo;</td>
                <?php } else { ?>
                    <td class="portf" style="width: 10%"
                        onclick="location.href='/portfolio/<?php echo $first['id']; ?>'">&laquo;</td>
                <?php } ?>
                <td style="width: 80%">
                ...
                <?php if (!empty($next['id'])) { ?>
                    <td class="portf" style="width: 10%"
                        onclick='location.href="/portfolio/<?php echo $next['id']; ?>"'>&raquo;</td>
                <?php } else { ?>
                    <td class="portf" style="width: 10%"
                        onclick='location.href="/portfolio/<?php echo $last['id']; ?>"'>&raquo;</td>
                <?php } ?>
            </table>
        </div>
